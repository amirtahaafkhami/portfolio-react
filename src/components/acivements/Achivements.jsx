...
function Achivements() {
  return (
    <section id="achivements-tab" className="min-h-[100vh] max-h-[200vh] w-full flex items-center justify-center md:left-4">
      <div className="flex md:flex-row flex-col items-center justify-center flex-wrap md:gap-0 gap-10 h-[100vh]">
