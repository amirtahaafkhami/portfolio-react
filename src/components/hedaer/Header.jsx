...
function Header() {
  ...
  return (
    <header id="home-tab" className={"h-[100vh] flex"}>
      <div id="navbar" className="fixed h-full items-center justify-center overflow-x-hidden hidden lg:flex" onClick={() => setNavbarVisibility(navbarVisibility === "hidden" ? "visible" : "hidden")}>
