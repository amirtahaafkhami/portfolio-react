...
function Header() {
  ...
  return (
    <header id="home-tab" className={"h-[100vh] flex"}>
      <div id="navbar" className="fixed h-full flex items-center justify-center overflow-x-hidden">
        <div className={"cursor-pointer relative flex flex-col items-center justify-center w-32 h-[100vh] bg-slate-50/10 transition-all duration-1000 border-r border-slate-50/20" + " " + (navbarVisibility === "visible" ? "-left-32" : "left-0")} onClick={() => setNavbarVisibility(navbarVisibility === "hidden" ? "visible" : "hidden")}>
      ...
      <div id="banner" className="h-full w-[100vw] flex flex-col justify-center items-center pl-16">
        <div id="header-text-container" className="text-center">
          <h1 className="font-GilroyBlack text-[70pt]">I am Amirtaha Afkhami.</h1>
